...
public class SharedPrefsHelper {
    private static final String SHARED_PREFS_NAME = "qb_user";
    ...
    private SharedPrefsHelper() {
        instance = this;
        sharedPreferences = BarberApplication.getInstance().getSharedPreferences(SHARED_PREFS_NAME, Context.MODE_PRIVATE);
    }
