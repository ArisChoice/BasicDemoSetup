package com.app.barber.util.quickblox.utils.imagepick;
...
import com.app.barber.util.quickblox.async.BaseAsyncTask;
import com.app.barber.util.quickblox.utils.ImageUtils;
import com.app.barber.util.quickblox.utils.ProgressDialogFragment;
import com.app.barber.util.quickblox.utils.SchemeType;
...
public class GetFilepathFromUriTask extends BaseAsyncTask<Intent, Void, File> {
    ...
    public File performInBackground(Intent... params) throws Exception {
        ...
        if (SchemeType.SCHEME_CONTENT.equalsIgnoreCase(uriScheme) && !isFromGoogleApp && !isKitKatAndUpper) {
            ...
            Cursor cursor = BarberApplication.getInstance().getContentResolver().query(uri, filePathColumn, null, null, null);
            if (cursor != null) {
