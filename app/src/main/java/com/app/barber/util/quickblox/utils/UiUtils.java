...
public class UiUtils {
    ...
    public static Drawable getColoredCircleDrawable(@ColorInt int color) {
        GradientDrawable drawable = (GradientDrawable) ResourceUtils.getDrawable(R.drawable.circular_blue_background);
    ...
    public static int getCircleColor(@IntRange(from = RANDOM_COLOR_START_RANGE, to = RANDOM_COLOR_END_RANGE)
        ...
        int colorId = BarberApplication.getInstance().getResources()
                .getIdentifier(colorIdName, "color", BarberApplication.getInstance().getPackageName());
