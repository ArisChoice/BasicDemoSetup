...
public class Toaster {
    ...
    public static void shortToast(View view, Window window, @StringRes int text) {
        Toast toast = makeToast(BarberApplication.getInstance().getString(text), Toast.LENGTH_SHORT);
    ...
    public static void shortToast(@StringRes int text) {
        shortToast(BarberApplication.getInstance().getString(text));
    }
    ...
    public static void longToast(@StringRes int text) {
        longToast(BarberApplication.getInstance().getString(text));
    }
    ...
    private static Toast makeToast(String text, @ToastLength int length) {
        return Toast.makeText(BarberApplication.getInstance(), text, length);
    }
