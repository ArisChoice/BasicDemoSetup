...
public class ErrorUtils {
    ...
    public static Snackbar showSnackbar(View view, @StringRes int errorMessage, Exception e,
        ...
        if (noConnection || timeout) {
            ...
            return showSnackbar(view, errorMessage, BarberApplication.getInstance().getString(R.string.no_internet_connection), actionLabel, clickListener);
        } else {
    ...
    public static Snackbar showSnackbar(View view, @StringRes int errorMessage, String error,
                                        @StringRes int actionLabel, View.OnClickListener clickListener) {
        String errorMessageString = BarberApplication.getInstance().getString(errorMessage);
    ...
    public static Snackbar showSnackbar(View view, @StringRes int message,
        ...
        snackBarView.setBackgroundColor(BarberApplication.getInstance().getResources().getColor(R.color.colorPrimary));
